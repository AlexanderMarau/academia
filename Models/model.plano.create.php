...
/**
 * <b>PlanoCreate.class:</b>
 * Classe responsável por gerenciamento dos dados da tabela planos!
 * 
 */
class PlanoCreate {
    ...
    /**
     * <b>novoPlano:</b> Executa um cadastro simplificado no banco de dados utilizando prepared statements.
     * Basta informar o nome da tabela e um array atribuitivo com nome da coluna e valor!
     * 
     * @param STRING $Tabela = Informe o nome da tabela no banco!
     * @param ARRAY $Dados = Informe um array atribuitivo. ( Nome Da Coluna => Valor ).
     */
    public function novoPlano($Tabela, array $Dados) {
