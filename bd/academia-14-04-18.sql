...
--
-- Host: 127.0.0.1
-- Generation Time: 14-Abr-2018 às 23:11
...
CREATE TABLE `anamneses` (
  `idanamneses` int(11) NOT NULL,
  `idalunos_cliente` int(11) NOT NULL,
  `peso_anamnese` float DEFAULT NULL,
  `altura_anamnese` float DEFAULT NULL,
  `imc_anamnese` float DEFAULT NULL,
  `pescoco_anamnese` float DEFAULT NULL,
  `ombro_anamnese` float DEFAULT NULL,
  `torax_anamnese` float DEFAULT NULL,
  `abdome_anamnese` float DEFAULT NULL,
  `cintura_anamnese` float DEFAULT NULL,
  `quadril_anamnese` float DEFAULT NULL,
  `bd_anamnese` float DEFAULT NULL,
  `be_anamnese` float DEFAULT NULL,
  `bec_anamnese` float DEFAULT NULL,
  `bdc_anamnese` float DEFAULT NULL,
  `aec_anamnese` float DEFAULT NULL,
  `adc_anamnese` float DEFAULT NULL,
  `ce_anamnese` float DEFAULT NULL,
...
--
-- Estrutura da tabela `cat_produto`
--
...
--
-- Extraindo dados da tabela `cat_produto`
--

INSERT INTO `cat_produto` (`idcate_produto`, `descricao`) VALUES
(1, 'Alimentício'),
(2, 'Vestimentas');
...
CREATE TABLE `cidade` (
  ...
  `desc_cidade` varchar(45) DEFAULT NULL,
...
--
-- Estrutura da tabela `endereco_aluno`
--
...
CREATE TABLE `endereco_aluno` (
  ...
  `idcidade` int(11) NOT NULL,
  `idestado` int(11) NOT NULL,
  `complementos_aluno` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `endereco_aluno`
--
...
CREATE TABLE `endereco_fornecedor` (
  `idendereco_forn` int(11) NOT NULL,
...
--
-- Estrutura da tabela `endereco_fun`
--

CREATE TABLE `endereco_fun` (
  `idendereco_fun` int(11) NOT NULL,
  `idcidade` int(11) DEFAULT NULL,
  `idestado` int(11) DEFAULT NULL,
  `complementos_fun` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Extraindo dados da tabela `endereco_fun`
--
...
INSERT INTO `estado` (`idestado`, `desc_estado`, `uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amapá', 'AP'),
(4, 'Amazonas', 'AM'),
...
--
-- Estrutura da tabela `estoq_prod`
--
...
--
-- Extraindo dados da tabela `historicos_mensalidades`
--

INSERT INTO `historicos_mensalidades` (`idhist_pag`, `idalunos_cliente`, `idplano`, `data_mens_pag`, `valor_pag`) VALUES
(1, 1, 2, '2018-04-14', '60.00'),
(2, 6, 3, '2018-04-10', '120.00');
...
(2, 2, 2, '2018-04-10', 'Vencido'),
(3, 3, 2, '2018-04-07', 'Pendente');
...
--
-- Extraindo dados da tabela `registros_catraca`
--

INSERT INTO `registros_catraca` (`idregistros_catraca`, `idaluno_clientes`, `hr_entrada_catraca`, `hr_saida_catraca`, `data_registro`) VALUES
(1, 1, '12:25:00', NULL, '2018-04-14'),
(2, 1, '14:00:00', NULL, '2018-04-14'),
(3, 8, '14:00:00', NULL, '2018-04-21'),
(4, 4, '10:00:00', NULL, '2018-04-02'),
(5, 2, '12:30:00', NULL, '2018-04-02'),
(6, 3, '12:45:00', NULL, '2018-04-14'),
(7, 8, '19:00:00', NULL, '2018-04-10'),
(8, 7, '23:00:00', NULL, '2018-04-02'),
(11, 1, '12:00:00', NULL, '2018-04-01'),
(12, 6, '10:00:00', NULL, '2018-04-02'),
(13, 2, '23:12:00', NULL, '2018-04-03'),
(14, 1, '02:08:00', NULL, '2018-04-14');
...
ALTER TABLE `alunos_cliente`
  ADD PRIMARY KEY (`idalunos_cliente`),
  ADD KEY `endereco_idx` (`idendereco_aluno`);

--
-- Indexes for table `anamneses`
--
ALTER TABLE `anamneses`
  ADD PRIMARY KEY (`idanamneses`),
  ADD KEY `fk_anamneses_alunos_cliente1_idx` (`idalunos_cliente`);

--
-- Indexes for table `cat_produto`
--
ALTER TABLE `cat_produto`
  ADD PRIMARY KEY (`idcate_produto`);
...
--
-- Indexes for table `endereco_aluno`
--
ALTER TABLE `endereco_aluno`
  ADD PRIMARY KEY (`idendereco_aluno`),
  ADD KEY `fk_endereco_cidade1_idx` (`idcidade`),
  ADD KEY `estado_aluno_idx` (`idestado`);

--
-- Indexes for table `endereco_fornecedor`
--
ALTER TABLE `endereco_fornecedor`
  ADD PRIMARY KEY (`idendereco_forn`),
  ADD KEY `cidade_idx` (`idcidade`),
  ADD KEY `estado_forn_idx` (`idestado`);

--
-- Indexes for table `endereco_fun`
--
ALTER TABLE `endereco_fun`
  ADD PRIMARY KEY (`idendereco_fun`),
  ADD KEY `cidade_fun_idx` (`idcidade`),
  ADD KEY `estado_fun_idx` (`idestado`);
...
ALTER TABLE `fornecedores`
  ...
  ADD KEY `fornecedores_idx` (`idendereco_forn`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_usuario_funcionarios1_idx` (`idfuncionarios`);
...
--
ALTER TABLE `anamneses`
  MODIFY `idanamneses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `historicos_mensalidades`
--
ALTER TABLE `historicos_mensalidades`
  MODIFY `idhist_pag` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `mensalidades`
  MODIFY `idmensalidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `registros_catraca`
  MODIFY `idregistros_catraca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `alunos_cliente`
  ADD CONSTRAINT `endereco` FOREIGN KEY (`idendereco_aluno`) REFERENCES `endereco_aluno` (`idendereco_aluno`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `anamneses`
--
ALTER TABLE `anamneses`
  ADD CONSTRAINT `fk_anamneses_alunos_cliente1` FOREIGN KEY (`idalunos_cliente`) REFERENCES `alunos_cliente` (`idalunos_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `endereco_aluno`
--
ALTER TABLE `endereco_aluno`
  ADD CONSTRAINT `cidade_aluno` FOREIGN KEY (`idcidade`) REFERENCES `cidade` (`idcidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estado_aluno` FOREIGN KEY (`idestado`) REFERENCES `estado` (`idestado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `endereco_fornecedor`
--
ALTER TABLE `endereco_fornecedor`
  ADD CONSTRAINT `cidade_forn` FOREIGN KEY (`idcidade`) REFERENCES `cidade` (`idcidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estado_forn` FOREIGN KEY (`idestado`) REFERENCES `estado` (`idestado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `endereco_fun`
--
ALTER TABLE `endereco_fun`
  ADD CONSTRAINT `cidade_fun` FOREIGN KEY (`idcidade`) REFERENCES `cidade` (`idcidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estado_fun` FOREIGN KEY (`idestado`) REFERENCES `estado` (`idestado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `estoq_prod`
  ADD CONSTRAINT `fk_estoques_produtos1` FOREIGN KEY (`idprodutos`) REFERENCES `produtos` (`idprodutos`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `fornecedores`
--
ALTER TABLE `fornecedores`
  ADD CONSTRAINT `fornecedores` FOREIGN KEY (`idendereco_forn`) REFERENCES `endereco_fornecedor` (`idendereco_forn`);
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuario_funcionarios1` FOREIGN KEY (`idfuncionarios`) REFERENCES `funcionarios` (`idfuncionarios`) ON DELETE NO ACTION ON UPDATE NO ACTION;
